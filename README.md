...
Group 2 had similar, albeit less drastic patterns. Group 2 had increased rates of mutation in limb direction. Robots tended to only have a few beneficial mutations over the 1000 generations compared to the control group. This meant that they would see rapid spikes in their fitness, especially in the early generations, followed by a levelling off.

Group 1 looked the most similar to the control group in terms of the overall evolution. There were many beneficial mutations, with each mutation usually improving fitness by a small amount. Fitness values ended up being more spread out. Group 3 had three seeds with fitness values above 120, three between 20 and 80, and four that were below 5. I attributed this inconsistency to the presence of axis mutations in this group. Changing the joint axis of a limb could potentially render an entire section of the body useless. I assume this is what happened in the seeds that were unable to get moving.

Based on the data, I would recommend evolving the robots with the 1/3, 1/3, 1/3 probability split. This seems to lead to the most consistently evolving robots. However, if you are looking for a single robot with great locomotion, I recommend evolving a larger population of robots with increased mutations in limb axis and size. Due to these two mutations being grouped together it is difficult to process the data, and I would like to separate them in the future. It would also be interesting to explore changing the style of mutation over time. Maybe using something like the control distribution of mutations is best early on, followed by an increased rate of mutation affecting joint placement or direction.
